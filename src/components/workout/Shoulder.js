  ...
  return (
    <div>
      ...
      <div>
          ...
          <blockquote>
            <h1>Shoulder Pain: Causes and Treatment</h1>
            <p>These are just some of the questions that our team of physiotherapists across ReLiva Physiotherapy clinics answers frequently. This is because painful shoulder conditions are a relatively common occurrence nowadays.
...
That is why in this post, we have collated answers to questions about common shoulder problems and what can be done to treat them for pain relief.
          ...
          Let’s begin by understanding the shoulder. Shoulder joint is the most movable joint in the body. It is also one of the most potentially unstable joints allowing an individual to place the hand in numerous positions. As a result, it is the site of many common problems.</p>
          </blockquote>
          <blockquote>
            <h2>What are the most common causes for Shoulder Pain?</h2>
            <b>Apart from sprain and strains, the most common causes for shoulder pain include the following. Read on to find more about each and treatment guidance for effective recovery:</b>
            <ul>
            <li>Shoulder dislocation</li>
            <li>Rotator Cuff Disease: Tendinitis and Bursitis</li>
            <li>Torn Rotator Cuff</li>
            <li>Frozen Shoulder (Adhesive Capsulitis)</li>
            <li>Fracture</li>
            <li>Arthritis of the Shoulder</li>
            <li>Other much less common causes are tumors, infection, and nerve-related problems</li>

            </ul>
          </blockquote>
          <blockquote>

              <h2>Shoulder Pain Causes and Treatment
              </h2>
               <h2>1) Shoulder Dislocation</h2>
              <blockquote>
                ...
                Shoulder Dislocation commonly occurs when there is a backward pull on the arm that either catches the muscles unprepared to resist or overwhelms the muscles. It could be of 2 types:
              ...
              <div style={{display:'flex',flexDirection:'row'}}>
                ...
                <h2>Rotator Cuff Bursitis:</h2>
                  Bursitis or inflammation of the bursa sacs that protect the shoulder, may accompany tendinitis and impingement syndrome.
             
                </div>
                  <div><img style={{width:'350px',height:'250px'}} src='https://cdn-djmgl.nitrocdn.com/WKDrbFhGmXUqrdsfVwgWscBHIyiXYRMC/assets/images/optimized/rev-e31e453/reliva.in/wp-content/uploads/2024/01/Rotator-cuff.webp' />
                  </div>
              </div>
              </blockquote>
              <h2>3) Torn Rotator Cuff</h2>
              <blockquote>
              ...
              <h2>4) Frozen Shoulder (Adhesive Capsulitis)</h2>
              <blockquote>
              ...
              <br></br>
              <br></br>
              <b>Interesting Facts about Frozen Shoulder:</b>
              <ul>
                <li>People with diabetes, stroke, lung disease, rheumatoid arthritis, and heart disease, or those who have been in an accident, are at a higher risk for frozen shoulder</li>
                <li>Frozen shoulder is more common among women than men.
                </li>
                <li>People between the ages of 40 and 70 are most likely to experience it</li>
              </ul>
              </blockquote>
            <h2> 5)  Shoulder Fracture</h2>
            <blockquote>
                  ...
                  When a fracture occurs, the doctor tries to bring the bones into normal alignment that will promote healing and restore arm movement. If someone’s clavicle is fractured, here is what they should do:

                  <ul>
                    <li>Patient must initially wear a strap and sling around the chest to keep the clavicle in place.
                  </li>
                  <li>
                  After removal of the strap and sling, the doctor will prescribe exercises to strengthen the shoulder and restore movement.
                  </li>
                  <li>Surgery is occasionally needed for certain clavicle fractures.</li>
                  </ul>
            ...
            <h2>6)  Arthritis of the Shoulder</h2>
            <blockquote>
              ...
              <h2>How is Shoulder Arthritis treated?</h2>
              Treatment of shoulder arthritis depends in part, on the type of arthritis.

              <h2>Osteoarthritis of the shoulder is usually treated with 2 pronged approach:</h2>
              <ol>
                <li>Nonsteroidal anti-inflammatory drugs
                </li><br></br>
                <li>Along with physiotherapy to restore normal functions</li><br></br>
              </ol>
             <h2> Rheumatoid arthritis requires :</h2>
             <ol>
            <li> Physiotherapy as the 1st line of treatment to maintain and regain the muscle strength, joint mobility and</li><br></br>
             <li> Additional medications such as corticosteroids may or may not be given.</li><br></br>
              <li>In case of failure of the non-operative treatment, surgery is opted where surgeon replaces the shoulder joint with an artificial ball for the top of the humerus and a cap (glenoid) for the scapula. Physiotherapy is a MUST post surgery for full recovery.
              </li>
             </ol>
            </blockquote>
