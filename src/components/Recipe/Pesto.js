    ...
    <div>
      ...
      <div className='main'>
          <div className='content'>
                 <div > <h1 style={{margin:'50px auto',paddingLeft:'40px'}}>Pesto Chicken and Veggies</h1></div>
                 <div>
                 ...
                 <div></div>
                 <div>
                  <blockquote><img style={{width:'100%',height:'900px'}} src='https://www.eatingbirdfood.com/wp-content/uploads/2024/07/Pesto-Chicken-Ingredients.jpg'/></blockquote>
                 </div>
                 
                 <div>
                    <blockquote><h1>How to Make Pesto Chicken and Veggies</h1>
