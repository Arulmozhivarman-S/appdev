...
<div className='main'>
  <div className='content'>
         <div > <h1 style={{margin:'50px auto',paddingLeft:'40px'}}>Spinach Salad</h1></div>
         <div>
         ...
         <div></div>
         <div>
          <blockquote><img style={{width:'100%',height:'900px'}} src='https://www.eatingbirdfood.com/wp-content/uploads/2024/07/Spinach-Salad-Ingredients-NEW-1.jpg'/></blockquote>
         </div>
         
         <div>
            <blockquote><h1>How to Make Spinach Salad</h1>
  ...
  <div className='imgcontent'>
    <div>
     ...
     <blockquote> <video width="100%" height="300" controls>
        <source src="https://videos.pexels.com/video-files/8844495/8844495-sd_960_506_24fps.mp4" type="video/mp4"/>
        </video></blockquote>
    </div>
    <div>
